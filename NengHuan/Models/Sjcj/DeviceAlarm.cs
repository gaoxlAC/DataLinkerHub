...
{
    // 定义设备告警实体类
    [SugarTable("device_alarm")]
    public class DeviceAlarm : Base 
    {
        // 定义实体类，与数据库表对应
        ...
        [SugarColumn(IsNullable = true, ColumnName = "alarm_value", ColumnDataType = "varchar", Length = 2)]
        public string AlarmValue { get; set; } // 预警值
