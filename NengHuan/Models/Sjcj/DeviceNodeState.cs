...
{
    // 定义设备节点状态实体类
    [SugarTable("device_node_state")]
    public class DeviceNodeState : Base
    {
        // 定义实体类，与数据库表对应
        ...
        [SugarColumn(IsNullable = true, ColumnName = "bool_value", ColumnDataType = "varchar", Length = 2)]
        public string  BoolValue { get; set; } // 状态值
