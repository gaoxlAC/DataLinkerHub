...
{
    [SugarTable("device_switch")]
    public class DeviceSwitch : Base
    {
        // 定义实体类，与数据库表对应
        ...
        [SugarColumn(IsNullable = true, ColumnName = "switch_value", ColumnDataType = "varchar", Length = 2)]
        public string BoolValue { get; set; } // 开关状态值
