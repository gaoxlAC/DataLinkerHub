...
namespace NengHuan.OPCUA
{
    ...
    public class OpcUaClient
    {
        ...
        #region Connect And Disconnect 连接服务器就是创建一个会话Session
        ...
        private async Task<Session> Connect(string serverUrl)
        {
            ...
            m_session = await Session.Create(
                ...
                60000,
                UserIdentity, // 相当于new UserIdentity(new AnonymousIdentityToken())，即用户身份为匿名
                              //new UserIdentity("sugar","12345"), // 服务器没有设置用户名与密码，用不了
                new string[] { });
        ...
        public DataValue ReadNode(NodeId nodeId)
        {
            ...
            m_session.Read(
                null,
                0,
                //TimestampsToReturn.Source, // 只返回源时间戳
                //TimestampsToReturn.Server, // 只返回服务器时间戳
                TimestampsToReturn.Both, // 都返回
                                         //TimestampsToReturn.Neither, // 都不返回
                nodesToRead,
        ...
        public List<object> ReadNodes(List<NodeId> nodeIds, List<Type> types)
        {
            List<object> values = null;
            List<ServiceResult> errors = null;
            m_session.ReadValues(nodeIds, types, out values, out errors); // 该方法能获取时间戳
            return values;
        }
        ...
        /// <summary>
        /// read several value nodes from server（同步）
        /// </summary>
        ...
        /// <summary>
        /// read several value nodes from server（异步）
        /// </summary>
        /// <param name="nodeIds">all NodeIds</param>
        /// <returns>all values</returns>
